      ...
      <Form>
        ...
        <Box display="flex" justifyContent="space-between">
          ...
          <Box sx={{ width: '635px' }}>
            ...
            <Box display="flex" alignItems="center">
              <Checkbox />
              <Typography variant="body1">AddOn Min-Max Validation</Typography>
            </Box>
            <Box display="flex" alignItems="center">
              <Checkbox />
              <Typography variant="body1">
          ...
          <Box sx={{ width: '635px' }}>
            ...
            <Box>
              <Box display="flex">
                ...
                <Typography variant="body1">Ex. 18[Current Year]</Typography>
              </Box>
              <Box display="flex">
                <Typography variant="body1" width={100}>
                  [yyyy]:
                </Typography>
                <Typography variant="body1">Ex. 2022[Current Year]</Typography>
              </Box>
              <Box display="flex">
                <Typography variant="body1" width={100}>
                  [mm]:
                </Typography>
                <Typography variant="body1">Ex. 01[Current Year]</Typography>
              </Box>
              <Box display="flex">
                <Typography variant="body1" width={100}>
                  [nmn]:
                </Typography>
                <Typography variant="body1">Ex. Jan[Current Year]</Typography>
              </Box>
              <Box display="flex">
                <Typography variant="body1" width={100}>
                  [dd]:
              ...
              <Box>
                ...
                <Box display="flex" alignItems="center">
                  <Checkbox />
                  <Typography variant="body1">
                    Skip Item Special notes focus on billing screen (only for
                    Keyboard View)
                  </Typography>
                </Box>
                <Box display="flex" alignItems="center">
          ...
          <Box sx={{ width: '635px' }}>
            ...
            <Box display="flex" alignItems="center">
              ...
              <Typography variant="body1" width="80%">
                Disable Taxes and Other Charges(Packing Charge, Delivery Charge,
                Service Charge) on Complimentary Bill
              </Typography>
            </Box>
            <Box display="flex" alignItems="center">
              <Checkbox />
              <Typography variant="body1" width="80%">
                Show Biller an option to release urgent KOTs while cancelling a
                bill (within same day KOTs only.) So biller can create new Bill
                using older KOTs.
              </Typography>
            </Box>
            <Box display="flex" alignItems="center">
